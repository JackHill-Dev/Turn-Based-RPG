...
public:
	...
	Interface(bool* brunning,std::map<std::string, RenderObject*>* objP, int* currentScene, std::vector<Character*>* currentEnemies, Player* player); //This is the constructor, we pass in the pointers to the various variables which sets them
