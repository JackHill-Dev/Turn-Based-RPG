...
public:
	...
	Interface(int* seed,bool* brunning,std::map<std::string, RenderObject*>* objP, Scenes* currentScene, std::vector<Character*>* currentEnemies, Player* player, Settings* settings, std::map<std::string, Item*>* nItems); //This is the constructor, we pass in the pointers to the various variables which sets them
