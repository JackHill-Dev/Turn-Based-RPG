...
{
	{"slashCard",{1, 10, 0, 10, 0, "Slash", "Slash the enemy for 5 damage, costs 10 stamina", "SlashCard" ,"swordSlashEffectObj", 0.5}},
	{"magicCard",{25, 5, 0, 5, 0, "Magic", "Slash the enemy for 5 damage, costs 10 stamina", "malePortrait" ,"MagicObj", 15.0}}
};