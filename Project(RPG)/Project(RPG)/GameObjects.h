...
{
	{
		...
		{"wizard", new SpriteSheet("Assets/Sprites/Portraits/Wizard.png",450, 694, 450, 694, 1)},
		{"rogue", new SpriteSheet("Assets/Sprites/Portraits/Rogue.png",527, 760, 527, 760, 1)},
		{"cleric", new SpriteSheet("Assets/Sprites/Portraits/Cleric.png",707, 960, 707, 960, 1)},
		{"warrior", new SpriteSheet("Assets/Sprites/Portraits/Warrior.png",728, 1134, 728, 1134, 1)},
