...
private:
	...
	std::vector<std::pair<int, int>> GoodNodePos
	{
		...
		std::make_pair(120,600), std::make_pair(240,400), std::make_pair(360,450), std::make_pair(480,400), std::make_pair(600,550), std::make_pair(720,550), std::make_pair(840,550), std::make_pair(960,650), std::make_pair(1080,650), std::make_pair(1200,650),
		...
		std::make_pair(120,7000), std::make_pair(240,700), std::make_pair(360,600), std::make_pair(480,550), std::make_pair(1500,650), std::make_pair(720,650), std::make_pair(1300,600), std::make_pair(1300,500), std::make_pair(1080,700), std::make_pair(1200,700),
	};
